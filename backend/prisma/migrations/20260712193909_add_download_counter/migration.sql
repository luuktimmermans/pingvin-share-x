...
INSERT INTO "new_Share" ("createdAt", "creatorId", "description", "expiration", "id", "isZipReady", "name", "removedReason", "reverseShareId", "storageProvider", "updatedAt", "uploadLocked", "views") SELECT "createdAt", "creatorId", "description", "expiration", "id", "isZipReady", "name", "removedReason", "reverseShareId", "storageProvider", "updatedAt", "uploadLocked", "views" FROM "Share";
DROP TABLE "Share";
