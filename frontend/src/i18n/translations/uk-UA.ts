export default {
  ...
  "admin.shares.table.downloads": "Завантаження",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Чи сповіщати автора спільного доступу електронною поштою, коли файл завантажено. Для цього потрібен SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Тема електронного листа, що надсилається автору спільного доступу після завантаження файлу.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Повідомлення, що надсилається автору спільного доступу після завантаження файлу. Доступні змінні:\n {downloader} - Особа, яка завантажила файл\n {fileName} - Назва завантаженого файлу\n {shareUrl} - URL-адреса спільного доступу",
