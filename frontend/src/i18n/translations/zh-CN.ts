export default {
  ...
  "admin.config.email.enable-share-download-notifications.description": "文件被下载时，是否通过电子邮件通知分享创建者。此功能需要启用 SMTP。",
  "admin.config.email.share-download-notification-subject": "下载通知邮件主题",
  "admin.config.email.share-download-notification-subject.description": "文件被下载时发送给分享创建者的电子邮件主题。",
  "admin.config.email.share-download-notification-message": "下载通知邮件内容",
  "admin.config.email.share-download-notification-message.description": "文件被下载时发送给分享创建者的消息。可用变量：\n {downloader} - 下载文件的人\n {fileName} - 已下载文件的名称\n {shareUrl} - 分享链接",
