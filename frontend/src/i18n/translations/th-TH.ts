export default {
  ...
  "admin.shares.table.downloads": "ดาวน์โหลด",
  ...
  "admin.config.email.enable-share-download-notifications.description": "กำหนดว่าจะแจ้งผู้สร้างการแชร์ทางอีเมลเมื่อมีการดาวน์โหลดไฟล์หรือไม่ ต้องใช้ SMTP",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "หัวเรื่องของอีเมลที่ส่งถึงผู้สร้างการแชร์เมื่อมีการดาวน์โหลดไฟล์",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "ข้อความที่ส่งถึงผู้สร้างการแชร์เมื่อมีการดาวน์โหลดไฟล์ ตัวแปรที่ใช้ได้:\n {downloader} - ผู้ที่ดาวน์โหลดไฟล์\n {fileName} - ชื่อไฟล์ที่ดาวน์โหลด\n {shareUrl} - URL ของการแชร์",
