export default {
  ...
  "admin.shares.table.downloads": "Stahování",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Zda upozornit autora sdílení e-mailem, když je soubor stažen. Tato funkce vyžaduje SMTP.",
  "admin.config.email.share-download-notification-subject": "Předmět oznámení stažení",
  "admin.config.email.share-download-notification-subject.description": "Předmět e-mailu odeslaného autorovi sdílení při stažení souboru.",
  "admin.config.email.share-download-notification-message": "Předmět oznámení stažení",
  "admin.config.email.share-download-notification-message.description": "Zpráva odeslaná autorovi sdílení při stažení souboru. Dostupné proměnné:\n {downloader} - Osoba, která soubor stáhla\n {fileName} - Název staženého souboru\n {shareUrl} - URL sdílení",
