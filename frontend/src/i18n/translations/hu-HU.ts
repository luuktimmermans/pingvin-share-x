export default {
  ...
  "admin.shares.table.downloads": "Letöltések",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Meghatározza, hogy értesítse-e a rendszer e-mailben a megosztás létrehozóját egy fájl letöltésekor. Ehhez SMTP szükséges.",
