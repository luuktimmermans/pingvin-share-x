export default {
  ...
  "admin.config.cache.redis-enabled.description": "Normalerweise speichert Pingvin Share Infos im Speicher. Wenn du mehrere Instanzen von Pingvin Share laufen hast, musst du Redis Caching aktivieren, damit der Cache zwischen den Instanzen geteilt wird.",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Ob der Ersteller der Freigabe per E-Mail benachrichtigt werden soll, wenn eine Datei heruntergeladen wird. Dies erfordert SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Betreff der E-Mail, die beim Herunterladen einer Datei an den Ersteller der Freigabe gesendet wird.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Nachricht, die beim Herunterladen einer Datei an den Ersteller der Freigabe gesendet wird. Verfügbare Variablen:\n {downloader} - Die Person, die die Datei herunterlädt\n {fileName} - Der Name der heruntergeladenen Datei\n {shareUrl} - Die URL der Freigabe",
