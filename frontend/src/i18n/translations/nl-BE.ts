export default {
  ...
  "admin.config.config-file-warning.description": "Aangezien je een geconfigureerde Pingvin-share hebt met een configuratiebestand, kun je de configuratie niet via de gebruikersinterface wijzigen.",
  ...
  "admin.config.cache.redis-enabled.description": "Normaal gesproken slaat Pingvin Share informatie op in het geheugen. Als u meerdere instanties van Pingvin Share gebruikt, moet u Redis-caching inschakelen om de cache tussen de instanties te delen.",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Of de maker van de share per e-mail wordt gewaarschuwd wanneer een bestand wordt gedownload. Hiervoor is SMTP vereist.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Onderwerp van de e-mail die naar de maker van de share wordt gestuurd wanneer een bestand wordt gedownload.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Bericht dat naar de maker van de share wordt gestuurd wanneer een bestand wordt gedownload. Beschikbare variabelen:\n {downloader} - De downloader van het bestand\n {fileName} - De naam van het gedownloade bestand\n {shareUrl} - De URL van de share",
