export default {
  ...
  "account.shares.table.downloads": "Prenosi",
  ...
  "admin.shares.table.downloads": "Prenosi",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Ali naj bo ustvarjalec skupne rabe ob prenosu datoteke obveščen po e-pošti. Za to je potreben SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Zadeva e-poštnega sporočila, poslanega ustvarjalcu skupne rabe ob prenosu datoteke.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Sporočilo, poslano ustvarjalcu skupne rabe ob prenosu datoteke. Razpoložljive spremenljivke:\n {downloader} - Oseba, ki prenese datoteko\n {fileName} - Ime prenesene datoteke\n {shareUrl} - URL skupne rabe",
