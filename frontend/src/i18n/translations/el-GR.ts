export default {
  ...
  "admin.shares.table.downloads": "Λήψεις",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Εάν ο δημιουργός της κοινοποίησης θα ειδοποιείται μέσω email όταν γίνεται λήψη ενός αρχείου. Απαιτείται SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Θέμα του email που αποστέλλεται στον δημιουργό της κοινοποίησης όταν γίνεται λήψη ενός αρχείου.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Μήνυμα που αποστέλλεται στον δημιουργό της κοινοποίησης όταν γίνεται λήψη ενός αρχείου. Διαθέσιμες μεταβλητές:\n {downloader} - Το άτομο που κατεβάζει το αρχείο\n {fileName} - Το όνομα του αρχείου που λήφθηκε\n {shareUrl} - Η διεύθυνση URL της κοινοποίησης",
