export default {
  ...
  "account.shares.table.downloads": "Preuzimanja",
  ...
  "admin.shares.table.downloads": "Preuzimanja",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Treba li obavijestiti autora dijeljenja e-poštom kada se datoteka preuzme. Za to je potreban SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Predmet e-poruke koja se šalje autoru dijeljenja kada se datoteka preuzme.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Poruka koja se šalje autoru dijeljenja kada se datoteka preuzme. Dostupne varijable:\n {downloader} - Osoba koja preuzima datoteku\n {fileName} - Naziv preuzete datoteke\n {shareUrl} - URL dijeljenja",
