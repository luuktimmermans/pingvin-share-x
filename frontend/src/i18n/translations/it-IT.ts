export default {
  ...
  "account.shares.table.downloads": "Download",
  "account.shares.table.lastDownload": "Ultimo download",
  "account.shares.table.lastDownloader": "Ultimo downloader",
  ...
  "admin.shares.table.downloads": "Download",
  ...
  "admin.config.email.share-download-notification-message.description": "Messaggio inviato al creatore della condivisione quando un destinatario scarica un file. Variabili disponibili: {downloader} - Chi scarica il file\n {fileName} - Il nome del file scaricato\n {shareUrl} - L'URL della condivisione",
