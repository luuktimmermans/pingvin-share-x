export default {
  ...
  "admin.config.email.enable-share-download-notifications.description": "Specifica se avvisare via email il creatore della condivisione quando viene scaricato un file. Richiede SMTP.",
