export default {
  ...
  "account.shares.table.downloads": "Descargas",
  ...
  "admin.shares.table.downloads": "Descargas",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Si se debe notificar por correo electrónico al creador del recurso compartido cuando se descarga un archivo. Esto requiere SMTP.",
  "admin.config.email.share-download-notification-subject": "Asunto de las notificaciónes de descarga",
  "admin.config.email.share-download-notification-subject.description": "Asunto del correo electrónico enviado al creador del recurso compartido cuando se descarga un archivo.",
  "admin.config.email.share-download-notification-message": "Mensaje de la notificación de descarga",
  "admin.config.email.share-download-notification-message.description": "Mensaje enviado al creador del recurso compartido cuando se descarga un archivo. Variables disponibles:\n {downloader} - La persona que descarga el archivo\n {fileName} - El nombre del archivo descargado\n {shareUrl} - La URL del recurso compartido",
