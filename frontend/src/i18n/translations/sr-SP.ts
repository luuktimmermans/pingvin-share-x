export default {
  ...
  "admin.shares.table.downloads": "Преузимања",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Да ли обавестити аутора дељења е-поштом када се датотека преузме. За то је потребан SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Наслов е-поруке која се шаље аутору дељења када се датотека преузме.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Порука која се шаље аутору дељења када се датотека преузме. Доступне променљиве:\n {downloader} - Особа која преузима датотеку\n {fileName} - Назив преузете датотеке\n {shareUrl} - URL дељења",
