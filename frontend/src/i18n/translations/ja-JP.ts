export default {
  ...
  "admin.config.email.enable-share-download-notifications.description": "ファイルがダウンロードされたときに、共有の作成者へメールで通知するかどうか。SMTP が必要です。",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "ファイルがダウンロードされたときに共有の作成者へ送信されるメールの件名。",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "ファイルがダウンロードされたときに共有の作成者へ送信されるメッセージ。使用可能な変数:\n {downloader} - ファイルをダウンロードした人\n {fileName} - ダウンロードされたファイル名\n {shareUrl} - 共有の URL",
