export default {
  ...
  "admin.shares.table.downloads": "Tải xuống",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Có gửi email thông báo cho người tạo chia sẻ khi một tệp được tải xuống hay không. Tính năng này yêu cầu SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Tiêu đề email được gửi cho người tạo chia sẻ khi một tệp được tải xuống.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Nội dung được gửi cho người tạo chia sẻ khi một tệp được tải xuống. Các biến có sẵn:\n {downloader} - Người tải tệp xuống\n {fileName} - Tên tệp đã tải xuống\n {shareUrl} - URL của chia sẻ",
