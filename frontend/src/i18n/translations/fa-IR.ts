export default {
  ...
  "account.shares.table.downloads": "دانلودها",
  ...
  "admin.shares.table.downloads": "دانلودها",
  ...
  "admin.config.email.enable-share-download-notifications.description": "آیا هنگام دانلود یک فایل، سازنده اشتراک از طریق ایمیل مطلع شود. این قابلیت به SMTP نیاز دارد.",
  "admin.config.email.share-download-notification-subject": "موضوع اعلان دانلود",
  "admin.config.email.share-download-notification-subject.description": "موضوع ایمیلی که هنگام دانلود یک فایل برای سازنده اشتراک ارسال می‌شود.",
  "admin.config.email.share-download-notification-message": "پیام اعلان دانلود",
  "admin.config.email.share-download-notification-message.description": "پیامی که هنگام دانلود یک فایل برای سازنده اشتراک ارسال می‌شود. متغیرهای موجود:\n {downloader} - دانلودکننده فایل\n {fileName} - نام فایل دانلودشده\n {shareUrl} - نشانی اشتراک",
