export default {
  ...
  "admin.shares.table.downloads": "Lataukset",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Ilmoitetaanko jaon luojalle sähköpostitse, kun tiedosto ladataan. Tämä edellyttää SMTP:tä.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Jaon luojalle tiedoston lataamisen yhteydessä lähetettävän sähköpostin aihe.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Jaon luojalle tiedoston lataamisen yhteydessä lähetettävä viesti. Käytettävissä olevat muuttujat:\n {downloader} - Tiedoston lataaja\n {fileName} - Ladatun tiedoston nimi\n {shareUrl} - Jaon URL-osoite",
