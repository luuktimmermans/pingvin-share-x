export default {
  ...
  "admin.config.email.enable-share-download-notifications.description": "Da li obavestiti autora deljenja e-poštom kada se datoteka preuzme. Za to je potreban SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Naslov e-poruke koja se šalje autoru deljenja kada se datoteka preuzme.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Poruka koja se šalje autoru deljenja kada se datoteka preuzme. Dostupne promenljive:\n {downloader} - Osoba koja preuzima datoteku\n {fileName} - Naziv preuzete datoteke\n {shareUrl} - URL deljenja",
