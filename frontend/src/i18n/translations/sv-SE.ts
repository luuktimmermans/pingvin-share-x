export default {
  ...
  "account.shares.table.downloads": "Nedladdningar",
  ...
  "admin.shares.table.downloads": "Nedladdningar",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Om den som skapade delningen ska meddelas via e-post när en fil laddas ner. Detta kräver SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Ämnet för e-postmeddelandet som skickas till den som skapade delningen när en fil laddas ner.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Meddelandet som skickas till den som skapade delningen när en fil laddas ner. Tillgängliga variabler:\n {downloader} - Personen som laddar ner filen\n {fileName} - Namnet på den nedladdade filen\n {shareUrl} - Delningens URL",
