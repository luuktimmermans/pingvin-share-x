export default {
  ...
  "admin.config.email.enable-share-download-notifications.description": "Si s'ha d'avisar per correu el creador de la compartició quan es descarrega un fitxer. Això requereix SMTP.",
  "admin.config.email.share-download-notification-subject": "Assumpte de la notificació de descàrrega",
  "admin.config.email.share-download-notification-subject.description": "Assumpte del correu que s'envia al creador de la compartició quan es descarrega un fitxer.",
  "admin.config.email.share-download-notification-message": "Missatge de la notificació de descàrrega",
  "admin.config.email.share-download-notification-message.description": "Missatge que s'envia al creador de la compartició quan es descarrega un fitxer. Variables disponibles:\n {downloader} - Qui descarrega el fitxer\n {fileName} - El nom del fitxer descarregat\n {shareUrl} - La URL de la compartició",
