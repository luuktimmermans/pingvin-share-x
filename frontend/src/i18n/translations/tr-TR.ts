export default {
  ...
  "admin.shares.table.downloads": "İndirme",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Bir dosya indirildiğinde paylaşım sahibinin e-postayla bilgilendirilip bilgilendirilmeyeceği. Bunun için SMTP gerekir.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Bir dosya indirildiğinde paylaşım sahibine gönderilen e-postanın konusu.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Bir dosya indirildiğinde paylaşım sahibine gönderilen mesaj. Kullanılabilir değişkenler:\n {downloader} - Dosyayı indiren kişi\n {fileName} - İndirilen dosyanın adı\n {shareUrl} - Paylaşımın URL adresi",
