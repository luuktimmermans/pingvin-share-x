export default {
  ...
  "account.shares.table.downloads": "Nedlastinger",
  ...
  "admin.shares.table.downloads": "Nedlastinger",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Om den som opprettet delingen skal varsles på e-post når en fil lastes ned. Dette krever SMTP.",
  "admin.config.email.share-download-notification-subject": "Emne for nedlastingsvarsel",
  "admin.config.email.share-download-notification-subject.description": "Emne for e-posten som sendes til den som opprettet delingen når en fil lastes ned.",
  "admin.config.email.share-download-notification-message": "Melding for nedlastingsvarsel",
  "admin.config.email.share-download-notification-message.description": "Melding som sendes til den som opprettet delingen når en fil lastes ned. Tilgjengelige variabler:\n {downloader} - Den som lastet ned filen\n {fileName} - Navnet på den nedlastede filen\n {shareUrl} - URL-en til delingen",
