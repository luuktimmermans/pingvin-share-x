export default {
  ...
  "admin.config.email.enable-share-download-notifications.description": "Se o criador do compartilhamento deve ser notificado por e-mail quando um arquivo for baixado. Isso requer SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Assunto do e-mail enviado ao criador do compartilhamento quando um arquivo é baixado.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Mensagem enviada ao criador do compartilhamento quando um arquivo é baixado. Variáveis disponíveis:\n {downloader} - A pessoa que baixou o arquivo\n {fileName} - O nome do arquivo baixado\n {shareUrl} - A URL do compartilhamento",
