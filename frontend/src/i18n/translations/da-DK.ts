export default {
  ...
  "admin.config.email.enable-share-download-notifications.description": "Om opretteren af delingen skal underrettes via e-mail, når en fil downloades. Dette kræver SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Emnet for den e-mail, der sendes til opretteren af delingen, når en fil downloades.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Beskeden, der sendes til opretteren af delingen, når en fil downloades. Tilgængelige variabler:\n {downloader} - Personen, der downloader filen\n {fileName} - Navnet på den downloadede fil\n {shareUrl} - Delingens URL",
