export default {
  ...
  "admin.config.email.enable-share-download-notifications.description": "파일이 다운로드될 때 공유 생성자에게 이메일로 알릴지 여부입니다. SMTP가 필요합니다.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "파일이 다운로드될 때 공유 생성자에게 전송되는 이메일의 제목입니다.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "파일이 다운로드될 때 공유 생성자에게 전송되는 메시지입니다. 사용 가능한 변수:\n {downloader} - 파일을 다운로드한 사람\n {fileName} - 다운로드된 파일 이름\n {shareUrl} - 공유 URL",
