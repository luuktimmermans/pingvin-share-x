export default {
  ...
  "admin.shares.table.downloads": "التحميلات",
  ...
  "admin.config.email.enable-share-download-notifications.description": "ما إذا كان سيتم إشعار منشئ المشاركة عبر البريد الإلكتروني عند تنزيل ملف. يتطلب ذلك SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "موضوع رسالة البريد الإلكتروني المرسلة إلى منشئ المشاركة عند تنزيل ملف.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "الرسالة المرسلة إلى منشئ المشاركة عند تنزيل ملف. المتغيرات المتاحة:\n {downloader} - الشخص الذي نزّل الملف\n {fileName} - اسم الملف الذي تم تنزيله\n {shareUrl} - رابط المشاركة",
