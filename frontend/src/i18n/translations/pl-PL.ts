export default {
  ...
  "account.shares.table.downloads": "Pobieranie",
  ...
  "admin.shares.table.downloads": "Pobieranie",
  ...
  "upload.dropzone.description": "Przeciągnij i upuść pliki tutaj, aby rozpocząć udostępnianie, lub naciśnij Ctrl+V, aby przesłać tekst ze schowka. Akceptujemy tylko pliki o łącznej wielkości {maxSize}.",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Czy powiadamiać twórcę udostępnienia e-mailem po pobraniu pliku. Wymaga to SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Temat wiadomości e-mail wysyłanej do twórcy udostępnienia po pobraniu pliku.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Wiadomość wysyłana do twórcy udostępnienia po pobraniu pliku. Dostępne zmienne:\n {downloader} - Osoba pobierająca plik\n {fileName} - Nazwa pobranego pliku\n {shareUrl} - Adres URL udostępnienia",
