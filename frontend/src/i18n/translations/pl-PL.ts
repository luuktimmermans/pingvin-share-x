export default {
  ...
  "admin.config.email.enable-share-download-notifications.description": "Whether to notify the share creator by email when a file is downloaded. This requires SMTP.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Subject of the email sent to the share creator when a file is downloaded.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Message sent to the share creator when a file is downloaded. Available variables:\n {downloader} - The downloader of the file\n {fileName} - The downloaded file name\n {shareUrl} - The URL of the share",
