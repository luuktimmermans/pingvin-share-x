export default {
  ...
  "admin.config.email.enable-share-download-notifications.description": "檔案被下載時，是否透過電子郵件通知分享建立者。此功能需要啟用 SMTP。",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "檔案被下載時傳送給分享建立者的電子郵件主旨。",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "檔案被下載時傳送給分享建立者的訊息。可用變數：\n {downloader} - 下載檔案的人\n {fileName} - 已下載檔案的名稱\n {shareUrl} - 分享連結",
