export default {
  ...
  "admin.shares.table.downloads": "Laadimised",
  ...
  "admin.config.email.enable-share-download-notifications.description": "Kas jagamise loojat teavitatakse e-posti teel, kui fail alla laaditakse. Selleks on vaja SMTP-d.",
  "admin.config.email.share-download-notification-subject": "Download notification subject",
  "admin.config.email.share-download-notification-subject.description": "Jagamise loojale faili allalaadimisel saadetava e-kirja teema.",
  "admin.config.email.share-download-notification-message": "Download notification message",
  "admin.config.email.share-download-notification-message.description": "Jagamise loojale faili allalaadimisel saadetav sõnum. Saadaolevad muutujad:\n {downloader} - Faili allalaadija\n {fileName} - Allalaaditud faili nimi\n {shareUrl} - Jagamise URL",
